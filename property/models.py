...
class Flat(models.Model):
    ...
    owner_phone_pure = models.CharField("Нормализованный номер владельца", max_length=20, blank=True)
    new_building = models.NullBooleanField(null=True, db_index=True, verbose_name="Новостройка")
